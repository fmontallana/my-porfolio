...
export default function About() {
    return (
        <div className='container flex flex-col items-center h-full w-11/12 lg:w-9/12 mx-auto py-2'>
            ...
            <div className='flex flex-col items-start lg:flex-row h-full w-full py-4 gap-10 text-center lg:text-left'>
                ...
                <div className='w-full flex-1 flex flex-col justify-center lg:justify-start items-center gap-4'>
                    <p className='text-slate-800 font-semibold text-center'>I'm a fresh graduate and am currently seeking a junior front-end developer position.</p>
