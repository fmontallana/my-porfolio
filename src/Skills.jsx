...
export default function Skills() {
    ...
    return (
        <div className='container flex flex-col items-center h-full w-9/12 mx-auto py-10'>
            <h1 className='lg:self-start py-4 text-2xl font-bold stretch-125 text-slate-800'>My Favorite Tools</h1>
            <div className='lg:h-[70vh] w-full grid grid-cols-1 lg:grid-cols-4  gap-4 '>
                <div className='h-full w-full hidden lg:flex flex-col  bg-slate-100 rounded-lg shadow-lg row-span-6 col-span-2 p-4'>
