...
export default function Hero() {
    ...
    return (
        <section className="container mx-auto flex-shrink-0 w-full h-full flex flex-col lg:flex-row ">
            <div className='absolute -top-64  h-full w-full lg:w-3/6 z-[1] flex justify-center items-center overflow-x-hidden lg:overflow-visible '>
