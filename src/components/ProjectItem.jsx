...
export default function ProjectItem({ project }) {
    ...
    return (
        <div className='z-20 flex flex-col-reverse lg:flex-row bg-slate-50 text-slate-700 lg:h-96 w-full lg:rounded-lg shadow-lg overflow-hidden border border-slate-300 '>
            <div className='h-full w-full lg:flex-1 p-4'>
                <div className='h-full w-full flex flex-col justify-evenly items-start gap-2'>
                    ...
                    <p className='text-xs lg:text-base text-slate-600'>{project.description}</p>
